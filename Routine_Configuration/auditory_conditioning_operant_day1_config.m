function [opts_vars, opts_vals] = auditory_conditioning_operant_day1_config(mouse,experimenter,type)
...
%General Options
opts_vals.routine_name='auditory_conditioning_operant_day1';
...
opts_vals.number_sequence = 20; %this is the number of sequence of 10 reward
