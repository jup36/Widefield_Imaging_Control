function [opts_vars, opts_vals] = auditory_conditioning_operant_day0_config(mouse,experimenter,type)
...
%General Options
opts_vals.routine_name='auditory_conditioning_operant_day0';
