function [opts_vars, opts_vals] = visual_conditioning_prob_pavlovian_day6_config(mouse,experimenter,type)
...
opts_vals.routine_name='visual_conditioning_prob_pavlovian_day6';
