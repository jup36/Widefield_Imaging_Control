function [opts_vars, opts_vals] = visual_conditioning_prob_pavlovian_reversal_config(mouse,experimenter,type)
...
opts_vals.routine_name='visual_conditioning_prob_pavlovian_reversal';

%Imaging Options
opts_vals.exposure_duration = 33.33;  %Camera Exposure in ms
opts_vals.framerate =1000/opts_vals.exposure_duration; %Frame rate
opts_vals.number_trials = 330; %number of trials
opts_vals.recording_duration=14.5*opts_vals.number_trials; %Total duration of the recording in seconds.
