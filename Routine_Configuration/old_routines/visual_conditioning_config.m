function [opts_vars, opts_vals] = visual_conditioning_config(mouse,experimenter,type)
...
opts_vals.routine_name='visual_conditioning_with_bhv_cam_tbytVideo';

%Imaging Options
opts_vals.exposure_duration = 33.33;  %Camera Exposure in ms
opts_vals.framerate =1000/opts_vals.exposure_duration; %Frame rate
opts_vals.recording_duration=16*300; %Total duration of the recording in seconds. put 4000 for 500 trials
