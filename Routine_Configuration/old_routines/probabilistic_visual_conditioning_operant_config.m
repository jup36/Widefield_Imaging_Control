function [opts_vars, opts_vals] = probabilistic_visual_conditioning_operant_config(mouse,experimenter,type)
...
opts_vals.routine_name='probabilistic_visual_conditioning_operant';

%Imaging Options
opts_vals.exposure_duration = 33.33;  %Camera Exposure in ms
opts_vals.framerate =1000/opts_vals.exposure_duration; %Frame rate
opts_vals.number_trials = 300; %number of trials
opts_vals.recording_duration=14*opts_vals.number_trials; %Total duration of the recording in seconds.
