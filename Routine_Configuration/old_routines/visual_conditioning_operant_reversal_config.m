function [opts_vars, opts_vals] = visual_conditioning_operant_reversal_config(mouse,experimenter,type)
...
opts_vals.routine_name='visual_conditioning_operant_reversal';
...
opts_vals.recording_duration=13*opts_vals.number_trials; %Total duration of the recording in seconds.
