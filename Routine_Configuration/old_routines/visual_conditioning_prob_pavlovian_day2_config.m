function [opts_vars, opts_vals] = visual_conditioning_prob_pavlovian_day2_config(mouse,experimenter,type)
...
opts_vals.routine_name='visual_conditioning_prob_pavlovian_day2';

%Imaging Options
opts_vals.exposure_duration = 33.33;  %Camera Exposure in ms
opts_vals.framerate =1000/opts_vals.exposure_duration; %Frame rate
opts_vals.recording_duration=14.5*200; %Total duration of the recording in seconds.
...
opts_vals.number_trials = 200; %number of trials
