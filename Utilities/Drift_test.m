function Drift_test(cyclespersecond, opts, movieDurationSecs)
...
% movieDurationSecs=2;        % Size of the grating image. Needs to be a power of two.
...
% gratingtex=Screen('MakeTexture', opts.window, grating, [], 1);
...
while toc<movieDurationSecs
   ...
   %gratingtex=Screen('MakeTexture', opts.window, opts.gratingMatrix{1},[],1);

Screen('DrawTexture', opts.window, opts.gratingtex{1}, srcRect)  %opts.gratingtex{dir_seq(1)}
