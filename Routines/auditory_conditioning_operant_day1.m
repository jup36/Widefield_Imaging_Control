function auditory_conditioning_operant_day1(app)
...
stimopts.stim_prob(stimopts.positive_stim) = 0.7;%70 ; %positive stim
stimopts.stim_prob(stimopts.negative_stim) = 0.3;%30 ; %negative stim
