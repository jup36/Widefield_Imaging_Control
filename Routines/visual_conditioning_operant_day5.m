function visual_conditioning_operant_day5(app)
...
stimopts.stim_prob(stimopts.positive_stim) = 0.6 ; %positive stim
stimopts.stim_prob(stimopts.neutral_stim) = 0 ; %neutral stim DOES NOT WORK WITH DRIFTING !!!!!
stimopts.stim_prob(stimopts.negative_stim) = 0.4 ; %negative stim
