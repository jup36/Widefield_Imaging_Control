function visual_conditioning_operant_day7(app)
...
stimopts.stim_prob(stimopts.positive_stim) = 0.45;%75 ; %positive stim
stimopts.stim_prob(stimopts.neutral_stim) = 0.1; %neutral stim
stimopts.stim_prob(stimopts.negative_stim) = 0.45;%25 ; %negative stim
